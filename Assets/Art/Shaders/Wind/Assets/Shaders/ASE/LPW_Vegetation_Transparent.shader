...
Shader "Art/LPW/ASE/Low Poly Vegetation Transparent"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float MB_RotationAngle97 = radians( ( ( ( ( MB_Amplitude880 + ( MB_AmplitudeOffset1356 * (StaticWorldNoise1340).r ) ) * sin( ( ( ( objToWorld1649.x + objToWorld1649.z ) + ( _Time.y * ( MB_Frequency873 + ( MB_FrequencyOffset1474 * (StaticWorldNoise1340).r ) ) ) ) * MB_Phase1360 ) ) ) + MB_DefaultBending877 ) * ( ase_positionOS.y / MB_MaxHeight1335 ) ) );
			float3 appendResult1558 = (float3(0.0 , ase_positionOS.y , 0.0));
			float3 rotatedValue1567 = RotateAroundAxis( appendResult1558, ase_positionOS, MB_RotationAxis1420, MB_RotationAngle97 );
			float3 rotatedValue1565 = RotateAroundAxis( float3( 0,0,0 ), rotatedValue1567, MB_RotationAxis1420, MB_RotationAngle97 );
			float3 LocalVertexOffset1045 = ( ( rotatedValue1565 - ase_positionOS ) * step( 0.01 , ase_positionOS.y ) );
...
Node;AmplifyShaderEditor.CommentaryNode;866;-6014.641,1535.244;Inherit;False;766.7373;1024.087;;19;877;1335;687;1334;880;300;1356;1360;1286;1262;870;1373;850;873;952;1474;480;1473;1650;Material Properties;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;489;-1403.765,1277.378;Inherit;False;1534.205;514.5131;;7;1651;292;1654;1653;295;294;515;Albedo;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;515;-1383.795,1346.087;Float;True;Property;_MainTex;Main Texture;0;1;[NoScaleOffset];Create;False;0;0;0;False;2;Header(Surface);Space;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;294;-1107.149,1428.456;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;295;-818.0504,1347.206;Inherit;True;Property;_MainTexture;Main Texture;0;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;1653;-509.2157,1429.721;Inherit;False;Property;_Color;Color;1;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1654;-264.7386,1349.983;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;1265;386.895,1920.538;Inherit;False;634.495;508.0168;;6;0;1495;1061;1496;296;1652;Master Node;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;292;-117.0576,1351.243;Float;False;Albedo;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1651;-501.7698,1618.708;Float;False;Opacity;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1650;-5735.798,2438.929;Inherit;False;Property;_AlphaCutoff;Alpha Cutoff;2;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1061;473.7657,2334.361;Inherit;False;1045;LocalVertexOffset;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1652;511.2692,2248.203;Inherit;False;1651;Opacity;1;0;OBJECT;;False;1;FLOAT;0
...
WireConnection;0;10;1652;0
WireConnection;0;11;1061;0
ASEEND*/
//CHKSM=A652F580C25F2E503B5153F904D7D1C37DF75857